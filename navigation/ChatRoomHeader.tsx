    ...
    return(
        ...
        >
            <Image
                ...
                source={{uri:chatUser?.imageUri ?? 'https://i.stack.imgur.com/34AD2.jpg'}}
            />
            <Text style={{flex:1,marginLeft:10,fontWeight:'bold',fontSize:19,color:colorScheme === 'dark' ? 'white' : 'black'}}>{chatUser?.name}</Text>
